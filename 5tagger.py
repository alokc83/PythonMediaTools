...
def update_mp3_metadata(file_path):
    ...
    After saving, the script verifies that the tags were correctly written.
    """
    ...
    try:
        ...
        # Verification: reload the file's tags
        ...
        if actual_artist == artist and actual_album == album:
            print(f"Successfully updated metadata for '{file_path}'. Tagging successful. ✅")
        else:
            print(f"Tag verification failed for '{file_path}'. Expected Artist='{artist}' and Album='{album}', "
