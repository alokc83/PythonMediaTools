...
# Usage
#   DRYRUN=1 ./empty-checker-n-deleter-fixed.sh /path/to/root
#   ./empty-checker-n-deleter-fixed.sh /path/to/root
#
# Optional
#   AUDIO_EXTS="mp3,m4a,m4b,flac,wav,aac,ogg" ./empty-checker-n-deleter-fixed.sh /path/to/root
#   REPORT_DIR="/path/to/reports" ./empty-checker-n-deleter-fixed.sh /path/to/root
...
# Step 2: mark dirs that contain audio, plus all ancestors
processed=0
